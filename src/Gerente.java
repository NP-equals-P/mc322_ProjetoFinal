...
public class Gerente extends Funcionario{
    ...
    public Gerente(Unidade unidade, String nome, String CPF, double salario) {
     ...
     */
    public void contratarFuncionario(String tipo, String nome, String cpf) {
        if (tipo.equals("Gerente")) {
            Gerente gerente = new Gerente(getUnidade(), nome, cpf, 4500.0);
            adicionarFuncionarioLista(gerente);
        }
        else {
            Vendedor vendedor = new Vendedor(getUnidade(), nome, cpf, 1500.0);
